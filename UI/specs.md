...
Create a button to open a dialog for shutting down or restarting the Raspberry Pi. The dialog should have options for "Shutdown", "Restart", and "Cancel". The "Shutdown" and "Restart" options should execute the appropriate system commands to perform these actions.
